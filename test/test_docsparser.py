...
from argize.docsparser import get_parameter_info_from_docstring, Param
...
class TestNumpyDocParser(DocParserBase):
    ...
    def test_typeinfo(self):
        ...
        self.assertParse(docstring, [
            Param(name="foo", typeinfo="int", description="My foo"),
            Param(name="bar", typeinfo="some weird type",
                  description="My bar"),
        ])
